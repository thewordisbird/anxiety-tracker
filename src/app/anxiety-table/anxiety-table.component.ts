...
export class AnxietyTableComponent {
  dataSource = ANXIETY_DATA;
  columnsToDisplay = ['date', 'time', 'level'];
  expandedElement: PeriodicElement | null;
}

export interface AnxietyItem {
  date: string;
  time: string;
  level: number;
  symptoms: string[];
...
const ANXIETY_DATA: AnxietyItem [] = [
  {
    date: new Date().toDateString(),
    time: "11:52 AM",
    level: 45,
    symptoms: ["Light Headed", "Stomach Pain"],
    thoughts: "Trouble understanding programming issue"
  },
  {
    date: new Date().toDateString(),
    time: "11:52 AM",
